...
/**
 * Exports the weekly report PDF from the app route and returns the blob so the
 * client can pre-generate the report before calling the edge mailer.
 */
  ...
  const doSend = useCallback(async () => {
    ...
    try {
      ...
      const payload: any = {
        ...
        preparedByDepartment: selectedPreparedByDepartment || "Admin and HR",
