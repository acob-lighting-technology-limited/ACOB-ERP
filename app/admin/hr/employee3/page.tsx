...
import { Employee3Content } from "./employee3-content"
...
const log = logger("admin-employee3")
...
export default async function AdminEmployee3Page() {
  ...
  return <Employee3Content initialEmployees={pageData.employees} userProfile={pageData.userProfile} />
}
