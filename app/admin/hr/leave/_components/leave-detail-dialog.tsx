...
export function LeaveDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[88vh] max-h-[88vh] max-w-3xl flex-col gap-0 overflow-hidden p-0 sm:rounded-xl">
        {/* Modal Header */}
              ...
              {activeTab === "overview" && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4 sm:gap-3">
                    <div className="bg-card rounded-lg border p-3 shadow-xs">
                      ...
                      <div className="mt-1 flex items-baseline gap-1">
                        <span className="text-foreground text-xl font-bold tracking-tight">{leave.days_count}</span>
                        <span className="text-muted-foreground text-xs">{leave.days_count === 1 ? "day" : "days"}</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-card rounded-lg border p-3 shadow-xs">
                      ...
                      <div className="mt-1">
                        <span className="text-foreground block truncate text-sm font-semibold">
                          {safeDateDisplay(leave.start_date)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="bg-card rounded-lg border p-3 shadow-xs">
                      ...
                      <div className="mt-1">
                        <span className="text-foreground block truncate text-sm font-semibold">
                          {safeDateDisplay(leave.end_date)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="bg-card rounded-lg border p-3 shadow-xs">
                      ...
                      <div className="mt-1">
                        <span className="text-foreground block truncate text-sm font-semibold">
                          {safeDateDisplay(leave.resume_date)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="bg-card space-y-3.5 rounded-lg border p-4 shadow-xs">
                      <div className="flex items-center justify-between border-b pb-2">
                        <span className="text-muted-foreground flex items-center gap-1.5 text-xs font-semibold tracking-wider uppercase">
                          <User className="text-primary h-3.5 w-3.5" /> Employee & Organization
                        </span>
                      </div>
                    ...
                    {/* Right Card: Leave Specifications */}
                    <div className="bg-card space-y-3.5 rounded-lg border p-4 shadow-xs">
                      <div className="flex items-center justify-between border-b pb-2">
                        <span className="text-muted-foreground flex items-center gap-1.5 text-xs font-semibold tracking-wider uppercase">
                          <FileCheck className="text-primary h-3.5 w-3.5" /> Leave Specifications
                        </span>
                      </div>
